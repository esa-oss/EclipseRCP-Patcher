...
public class ToolItem extends Item {
  ...
  public Rectangle getBounds() {
    ...
    // [DM] RAP - RAP performance improvement
    long currentTime = System.currentTimeMillis();
    if (this.cachedBounds == null || (currentTime - this.firstCacheTime < 3000) || (currentTime - this.lastCacheTime > 3000))
    {
    ...
    this.cachedBounds = new Rectangle( left, top, width, height );
  ...
  private long firstCacheTime = System.currentTimeMillis();
  ///###############  END PATCH CONTRIBUTION  ###############
