...
public abstract class AbstractCSSEngine implements CSSEngine {
    ...
    public AbstractCSSEngine(ExtendedDocumentCSS documentCSS) {
        ...
        ///############### START PATCH CONTRIBUTION ###############
        if (instanceCount++ == 0)
            System.out.println("Patched AbstractCSSEngine class effective.");
        ///###############  END PATCH CONTRIBUTION  ###############
    }
    ...
    public Element getElement(Object element) {
        ...
        ///############### START PATCH CONTRIBUTION ###############
        // DM: Fixes Eclipse Bug 506120
        // Applied patch as indicated at 
        // http://git.eclipse.org/c/platform/eclipse.platform.ui.git/commit/?id=2a1e9ad46dfc350cbbfb5a511b59281264649882
        if (element == null) {
            return elt;
        }
        ///###############  END PATCH CONTRIBUTION  ###############        
