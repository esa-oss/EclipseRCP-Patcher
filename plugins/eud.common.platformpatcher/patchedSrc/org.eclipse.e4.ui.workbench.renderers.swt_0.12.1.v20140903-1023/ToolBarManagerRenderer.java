...
public class ToolBarManagerRenderer extends SWTPartRenderer {
    ...
    static
    {
        System.out.println("ViewPart switch performance patch 4/4 effective.");
    }
    ...
    private boolean processAddition(final MToolBar toolbarModel,
        ...
        if (record.anyVisibleWhen()) {
            ...
            parentContext.runAndTrack(new RunAndTrack() {
                ...
                ///############### START PATCH CONTRIBUTION ###############
                @Override
                public final boolean changed(final IEclipseContext context) {
                    return changedWithSkipRedundantUpdates(context, false);
                }
                
                @Override
                public boolean changedWithSkipRedundantUpdates(final IEclipseContext context, final boolean skipRedundantUpdates)
                {
                ///###############  END PATCH CONTRIBUTION  ###############
